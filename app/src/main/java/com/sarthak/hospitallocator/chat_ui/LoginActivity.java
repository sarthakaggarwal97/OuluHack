...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.sarthak.hospitallocator.R.layout.activity_login);
        fab = (FloatingActionButton) findViewById(com.sarthak.hospitallocator.R.id.fab);
        editTextUsername = (EditText) findViewById(com.sarthak.hospitallocator.R.id.et_username);
        editTextPassword = (EditText) findViewById(com.sarthak.hospitallocator.R.id.et_password);
    ...
    class AuthUtils {
        ...
        void createUser(String email, String password) {
            waitingDialog.setIcon(com.sarthak.hospitallocator.R.drawable.ic_add_friend)
        ...
        void signIn(String email, String password) {
            waitingDialog.setIcon(com.sarthak.hospitallocator.R.drawable.ic_person_low)
                    .setTitle("Login....")
                    .setTopColorRes(com.sarthak.hospitallocator.R.color.colorPrimary)
                    .show();
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                new LovelyInfoDialog(LoginActivity.this) {
                                    ...
                                    public LovelyInfoDialog setConfirmButtonText(String text) {
                                        ...
                                        .setTopColorRes(com.sarthak.hospitallocator.R.color.colorAccent)
                                        .setIcon(com.sarthak.hospitallocator.R.drawable.ic_person_low)
